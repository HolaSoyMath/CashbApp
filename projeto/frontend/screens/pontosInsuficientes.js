...
import VendaOK from '../src/images/vendaRegistrada/excluir.png'


export default function PontosInsuficientes(props){
    ...
    <View style={styles.principal}>
      ...
      <View style={stylesBody.principal}>
        <View style={stylesBody.containerTitulo}> 
          ...
          <Text style={stylesBody.textoTitulo}>Solicitação recusada</Text>
          <Text style={stylesBody.textoSubTitulo}>Sua solicitação de troca foi recusada pois ainda não possue pontos suficientes.</Text>
        </View>
      </View>
